...
var firmwareTemplate = '<tr><th scope="row">{ $INDEX }</th><td>{ $VERSION }</td><td>{ $REGION }</td><td>{ $RELEASE_DATE }</td><td><a href="#" class="showChangelog">Show changelog</a></td><td><a href="{ $URL }">{ $URL }</a></td>';
var changelogs = [];
